    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="收货人" prop="shouhuodizhiName">
                       <el-input v-model="ruleForm.shouhuodizhiName"
                                 placeholder="收货人" clearable  :readonly="ro.shouhuodizhiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电话" prop="shouhuodizhiPhone">
                       <el-input v-model="ruleForm.shouhuodizhiPhone"
                                 placeholder="电话" clearable  :readonly="ro.shouhuodizhiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="地址" prop="shouhuodizhiDizhi">
                       <el-input v-model="ruleForm.shouhuodizhiDizhi"
                                 placeholder="地址" clearable  :readonly="ro.shouhuodizhiDizhi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="地址" prop="shouhuodizhiDizhi">
                           <el-input v-model="ruleForm.shouhuodizhiDizhi"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    shouhuodizhiName: false,
                    shouhuodizhiPhone: false,
                    shouhuodizhiDizhi: false,
                    insertTime: false,
                    updateTime: false,
                },
                ruleForm: {
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shouhuodizhi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shouhuodizhiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
