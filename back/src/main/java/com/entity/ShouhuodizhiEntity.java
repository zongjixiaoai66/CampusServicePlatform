...
public class ShouhuodizhiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShouhuodizhiEntity() {

	}

	public ShouhuodizhiEntity(T t) {
		try {
    ...
    public String toString() {
        return "Shouhuodizhi{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", shouhuodizhiName=" + shouhuodizhiName +
            ", shouhuodizhiPhone=" + shouhuodizhiPhone +
            ", shouhuodizhiDizhi=" + shouhuodizhiDizhi +
